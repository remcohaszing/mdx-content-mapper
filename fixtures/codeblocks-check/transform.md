...
```jsx 0 39 464 39 0 1048575
import type { ReactNode } from 'react'

```

```jsx 39 41 506 41 0 1048575
export function Component(): ReactNode {

```

```jsx 80 17 549 17 0 1048575
  return <div />

```

```jsx 97 2 568 2 0 1048575
}
